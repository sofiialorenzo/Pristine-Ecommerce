...
<div class="container mx-auto px-4 py-28">
    ...
    <h1 class="text-center font-bold text-2xl md:text-3xl lg:text-4xl mb-16 text-gray-900" aria-label="Administración de Marcas">Administración de Marcas</h1>
    <div class="hidden lg:block overflow-x-auto shadow-lg rounded-lg bg-white">
        <table class="min-w-full table-auto" aria-label="Lista de marcas">
            <thead class="bg-violet-200">
                <tr>
                    <th class="px-4 py-2 text-left text-gray-800" scope="col">Nombre de la marca</th>
                    ...
                    <tr class="border-b hover:bg-violet-50">
                        ...
                        <td class="px-4 py-3 space-y-2">
                            <a href="index.php?sec=delete_marca&id=<?= $marca->getId() ?>" 
                               ...
                               aria-label="Eliminar marca: <?= $marca->getMarcaCompleta() ?>">
                                Eliminar
                            </a>
                        </td>
                    </tr>
    ...
    <div class="grid gap-6 mt-6 lg:hidden">
        <?php foreach ($marcas as $marca) { ?>
            <div class="p-4 shadow-lg rounded-lg bg-white flex flex-col space-y-4" aria-label="Marca: <?= $marca->getMarcaCompleta() ?>">
                <div>
